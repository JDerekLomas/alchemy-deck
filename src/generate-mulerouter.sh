#!/bin/bash
# Generate all 34 alchemy deck cards using MuleRouter API
...
OUTPUT_DIR="/Users/dereklomas/new/alchemy-deck/docs/cards"
...
generate_card() {
    ...
    # Capture just JSON output by filtering out progress lines
    result=$(uv run python models/google/nano-banana/generation.py \
        --prompt "$full_prompt" \
        --aspect-ratio "9:16" \
...
# ELEMENTS
generate_card "elem-01" "Elemental Fire, roaring alchemical flames in upward-pointing triangle, salamander spirit unharmed within the blaze, solar rays"

generate_card "elem-02" "Elemental Water, mercurial waters flowing within downward-pointing triangle, undine spirit swimming in lunar-lit depths"

generate_card "elem-03" "Elemental Air, swirling philosophical winds within triangle with horizontal line, sylph spirits soaring among clouds"

generate_card "elem-04" "Elemental Earth, inverted triangle with horizontal line, gnome spirit guarding underground treasures, crystals growing from soil"

generate_card "elem-05" "Quintessence fifth element, eternal immutable essence beyond the four elements, spiraling celestial sphere with fixed stars, divine light"
...
echo "=========================================="
echo "COMPLETE! Generated 34 cards"
echo "Output: $OUTPUT_DIR"
echo "=========================================="
ls -la "$OUTPUT_DIR"/*.png | head -40
